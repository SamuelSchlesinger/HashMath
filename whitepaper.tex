...
\begin{quote}
\emph{Bitcoin solved double-spending without trusted third parties~\cite{nakamoto2008}.
...
HashMath retains the 9 constructors that carry type-theoretic content and excludes the
...
HashMath uses SHA-256 instead of SHA3 but the content-addressing architecture is analogous.
